...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,  KC_Z,   KC_X,    KC_C,   KC_V,    KC_B,          MO(_PROG), KC_N,   KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,  RSFT_ENT,
      KC_LCTL,  KC_LOPT,         KC_LGUI,         KC_BSPC,       SYM_SPC,           MO(_NAV),                    KC_TRNS,  KC_TRNS
    ),
    ...
    [_SYM] = LAYOUT(
      ...
      KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,          KC_MINS,   KC_UNDS,   KC_PLUS,   KC_LCBR,   KC_RCBR,    KC_PIPE, KC_TRNS,
